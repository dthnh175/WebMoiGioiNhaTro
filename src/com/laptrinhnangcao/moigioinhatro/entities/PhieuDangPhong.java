...
public class PhieuDangPhong implements java.io.Serializable {
	...
	private Integer tienDien;

	@Column(name = "tien_nuoc")
	private Integer tienNuoc;

	@Column(name = "ngay_dang")
//	@Type(type = "com.laptrinhnangcao.moigioinhatro.models.DateTimeHibernateUserType")
...
//	@Column(name = "")
	@OneToMany(mappedBy = "phieuDangPhong")
	transient private Set<Anh> anhs = new HashSet<Anh>(0);
	...
	public PhieuDangPhong(ChuPhong chuPhong, Phong phong, TienIch tienIch, int tienGiuCho, int tienDatCoc, int tienThue,
			int tienDien, int tienNuoc, Timestamp ngayDang, Boolean trangThai, Set<Anh> anhs) {
